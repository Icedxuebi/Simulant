...
namespace Simulant.ACT
{
    ...
    /// </remarks>
    internal sealed class GreyMagicCallScheduler : IDisposable
    {
        ...
        private readonly GreyMagicExternalProcessMemory _memory;
        ...
        internal GreyMagicCallScheduler(GreyMagicExternalProcessMemory memory, int frameLeaseMs = 10)
        {
            if (frameLeaseMs <= 0)
